...
function createV2BlockTemplates(language: string, timezone: string): V2Section[] {
	...
	// 🌟 你的 R2 真实公共存储桶域名
	const r2 = "https://r2.eplayerx.cc.cd";
	...
	return [
		...
		...doubanTailBlocks,
		{
			...
			preset: "poster-list",
			showRank: true,
			source: { path: "/tmdb/discover/tv", query: { with_original_language: "ko", sort_by: "popularity.desc", language, page: 1 }, itemEnvelope: "results", pagination: { pageParam: "page", startPage: 1 } },
		},
		{
			...
			preset: "poster-list",
			showRank: true,
			source: { path: "/tmdb/discover/tv", query: { with_original_language: "ja", with_genres: 18, without_genres: "16,10762", without_keywords: "317204", "first_air_date.gte": "2018-01-01", "vote_count.gte": 15, sort_by: "popularity.desc", language, page: 1 }, itemEnvelope: "results", pagination: { pageParam: "page", startPage: 1 } },
		},
		{
			...
			preset: "poster-list",
			showRank: true,
			source: { path: "/tmdb/discover/tv", query: { with_original_language: "es", with_genres: 18, without_genres: "16,10762,10764", "first_air_date.gte": "2018-01-01", "vote_count.gte": 20, sort_by: "popularity.desc", language, page: 1 }, itemEnvelope: "results", pagination: { pageParam: "page", startPage: 1 } },
		},
		{
			...
			preset: "poster-list",
			showRank: true,
			source: { path: "/tmdb/discover/tv", query: { with_original_language: "zh", with_origin_country: "TW", sort_by: "popularity.desc", "first_air_date.gte": "2021-01-01", "vote_count.gte": 5, language, page: 1 }, itemEnvelope: "results", pagination: { pageParam: "page", startPage: 1 } },
		},
		{
		...
		// -------------------------------------------------------------
		{
			...
			children: [1, 2, 3, 4, 5, 6, 7].map(d => ({
				...
				mediaType: "tv",
				preset: "poster-list",
				source: { path: `${r2}/weekly_drama_collection-${d}.json`, itemEnvelope: "data" }
			}))
		} as unknown as HomeBlockTemplate,
		{
			...
			children: [1, 2, 3, 4, 5, 6, 7].map(d => ({
				...
				mediaType: "tv",
				preset: "poster-list",
				source: { path: `${r2}/weekly_guoman_collection-${d}.json`, itemEnvelope: "data" }
			}))
		} as unknown as HomeBlockTemplate,
		{
			...
			children: [1, 2, 3, 4, 5, 6, 7].map(d => ({
				...
				mediaType: "tv",
				preset: "poster-list",
				source: { path: `${r2}/weekly_anime_collection-${d}.json`, itemEnvelope: "data" }
			}))
		} as unknown as HomeBlockTemplate,
		{
			...
			children: [1, 2, 3, 4, 5, 6, 7].map(d => ({
				...
				mediaType: "tv",
				preset: "poster-list",
				source: { path: `${r2}/weekly_korean_drama_collection-${d}.json`, itemEnvelope: "data" }
			}))
		} as unknown as HomeBlockTemplate,
		{
			...
			children: [1, 2, 3, 4, 5, 6, 7].map(d => ({
				...
				mediaType: "tv",
				preset: "poster-list",
				source: { path: `${r2}/weekly_japanese_drama_collection-${d}.json`, itemEnvelope: "data" }
			}))
		} as unknown as HomeBlockTemplate,
		{
			...
			children: [1, 2, 3, 4, 5, 6, 7].map(d => ({
				...
				mediaType: "tv",
				preset: "poster-list",
				source: { path: `${r2}/weekly_sea_drama_collection-${d}.json`, itemEnvelope: "data" }
			}))
		} as unknown as HomeBlockTemplate,

		// -------------------------------------------------------------
		// 🌟 3. 自建大盘专属分类 (直接读取 R2 存储桶中对应的具体 .json 文件)
		// -------------------------------------------------------------
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-popular-movies.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_popular_tv",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-popular-tv.json`, itemEnvelope: "data" }
		},
		{
			id: "bangumi_airing",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/bangumi-airing.json`, itemEnvelope: "data" }
		},
		{
			id: "douban_tv_custom",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/douban-tv-custom.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_netflix",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-netflix.json`, itemEnvelope: "data" }
		},
		{
			id: "variety_cn",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/variety-cn.json`, itemEnvelope: "data" }
		},
		{
			id: "variety_kr",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/variety-kr.json`, itemEnvelope: "data" }
		},
		{
			id: "variety_global",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/variety-global.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_hbo",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-hbo.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_apple",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-apple.json`, itemEnvelope: "data" }
		},
		{
			id: "trakt_movies",
			mediaType: "movie",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/trakt-movies.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_anime_cn",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-anime-cn.json`, itemEnvelope: "data" }
		},
		{
			id: "trakt_shows",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/trakt-shows.json`, itemEnvelope: "data" }
		},
		{
			id: "douban_movies",
			mediaType: "movie",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/douban-movies.json`, itemEnvelope: "data" }
		},
		{
			id: "douban_korean_tv",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/douban-korean-tv.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_ja",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-ja.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_anime_jp",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-anime-jp.json`, itemEnvelope: "data" }
		},
		{
			id: "imdb_top_anime",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/imdb-top-anime.json`, itemEnvelope: "data" }
		},
		{
			id: "prime_hot_anime",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/prime-hot-anime.json`, itemEnvelope: "data" }
		},
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/filmarks-anime-movie.json`, itemEnvelope: "data" }
		},
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/netflix-hot-anime.json`, itemEnvelope: "data" }
		},
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-anime-top-ja.json`, itemEnvelope: "data" }
		},
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-anime-movie-ja.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_es",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-es.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_tw",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-tw.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_movie_tw",
			mediaType: "movie",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-movie-tw.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_movie_sea",
			mediaType: "movie",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-movie-sea.json`, itemEnvelope: "data" }
		},
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-movie-hk-erotic-comedy.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_th",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-th.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_movie_th",
			mediaType: "movie",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-movie-th.json`, itemEnvelope: "data" }
		},
		{
			id: "tmdb_tv_bl",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/tmdb-tv-bl.json`, itemEnvelope: "data" }
		},
		{
			id: "netflix_tv_minor",
			mediaType: "tv",
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/netflix-tv-minor.json`, itemEnvelope: "data" }
		},
		{
			...
			showRank: true,
			showOverview: true,
			source: { path: `${r2}/netflix-movie-minor.json`, itemEnvelope: "data" }
		}
	];
}
