...
/**
 * Default homepage V2. Pure official default template.
 */
...
const TITLE_TRANSLATIONS: Record<HomeTitleKey, Record<Locale, string>> = {
	...
	"home.popular_korean_tv_shows": { en: "Popular Korean Dramas", zh: "热门韩国电视剧", "zh-Hant": "熱門韓國電視劇", ja: "人気の韓国ドラマ", es: "Dramas Coreanos Populares", ar: "دراما كورية شائعة" },
	"home.popular_japanese_tv_shows": { en: "Popular Japanese Dramas", zh: "热门日本电视剧", "zh-Hant": "熱門日本電視劇", ja: "人気の日本ドラマ", es: "Dramas Japoneses Populares", ar: "دراما يابانية شائعة" },
	"home.popular_spanish_tv_shows": { en: "Popular Spanish-Language Series", zh: "热门西语剧集", "zh-Hant": "熱門西語劇集", ja: "人気のスペイン語シリーズ", es: "Series en Español Populares", ar: "مسلسلات إسبانية شائعة" },
	"home.popular_taiwanese_tv_shows": { en: "Popular Taiwanese Dramas", zh: "热门台湾电视剧", "zh-Hant": "熱門台灣電視劇", ja: "人気の台湾ドラマ", es: "Dramas Taiwaneses Populares", ar: "دراما تايوانية شائعة" },
