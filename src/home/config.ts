...
interface HomeBlock { id: string; title?: string; mediaType?: "movie" | "tv"; preset: string; sort?: string; showRank?: boolean; showOverview?: boolean; source?: HomeBlockSource; metadata?: { isAnime?: boolean; }; route?: TmdbListRoute; }
...
const TITLE_TRANSLATIONS: Record<HomeTitleKey, Record<Locale, string>> = {
  ...
  "home.tmdb_popular_movies": { en: "Today's Popular Movies", zh: "今日热门电影", "zh-Hant": "今日熱門电影", ja: "今日の人気映画", es: "Películas Populares de Hoy", ar: "أفلام شائعة" },
  ...
  return [
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_popular_tv", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_popular_movies", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "bangumi_airing",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/bangumi_airing", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "imdb_top_anime",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/imdb_top_anime", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "prime_hot_anime",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/prime_hot_anime", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/filmarks_anime_movie", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/netflix_hot_anime", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_anime_top_ja", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_anime_jp",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_anime_jp", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
    ...
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_anime_cn", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_netflix",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_netflix", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_hbo",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_hbo", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_apple",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_apple", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "trakt_movies",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/trakt_movies", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "trakt_shows",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/trakt_shows", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "douban_movies",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/douban_movies", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "douban_tv",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/douban_tv", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "variety_cn",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/variety_cn", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "variety_kr",
      mediaType: "tv",
    ...
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/variety_global", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "douban_korean_tv",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/douban_korean_tv", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_ja",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_ja", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_tw",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_tw", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_movie_tw",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_movie_tw", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_movie_hk_erotic_comedy", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_th",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_th", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_movie_th",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_movie_th", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_movie_sea",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_movie_sea", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_es",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_es", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "netflix_tv_minor",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/netflix_tv_minor", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/netflix_movie_minor", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_bl",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://movie-api.l3okuu.workers.dev/api/tmdb_tv_bl", query: { sort: "year" }, itemEnvelope: "data" },
    },
