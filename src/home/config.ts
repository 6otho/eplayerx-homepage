...
/**
 * Custom Homepage Config (V2 Ready).
 * Exporting createDefaultHomeConfig for client custom data.
 */
...
const TITLE_TRANSLATIONS: Record<string, Record<Locale, string>> = {
	...
	"home.tmdb_popular_movies": { en: "今日热门电影", zh: "今日热门电影", "zh-Hant": "今日熱門電影", ja: "今日の人気映画", es: "Películas Populares de Hoy", ar: "أfلام شائعة" },
...
// 🌟 主导出函数：匹配服务端的 createDefaultHomeConfig
