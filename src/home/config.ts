...
const TITLE_TRANSLATIONS: Record<string, Record<Locale, string>> = {
	...
	"home.popular_taiwanese_movies": { en: "Authentic Taiwanese Movies", zh: "台味正浓的宝藏台片", "zh-Hant": "台味正濃的寶藏台片", ja: "人気の台湾映画", es: "Películas Taiwanesas Populares", ar: "أفلام تايوانية شهيرة" },
	...
	"home.trakt_movies": { en: "Visual Blockbuster Movies", zh: "视效轰炸欧美大片", "zh-Hant": "視效轟炸歐美大片", ja: "大ヒット映画", es: "Películas Populares de Trakt", ar: "أفلام رائجة" },
	...
	"home.tmdb_anime_movie_ja": { en: "Wallpaper Quality Anime Movies", zh: "美到想截屏的动画电影", "zh-Hant": "美到想截圖的動畫電影", ja: "名作アニメ映画", es: "Películas de Anime Aclamadas", ar: "أفلام أنمي مميزة" },
	"home.tmdb_movie_sea": { en: "Sensual Southeast Asian Movies", zh: "荷尔蒙溢出的东南亚", "zh-Hant": "荷爾蒙溢出的東南亞", ja: "東南アジア映画", es: "Películas del Sudeste Asiático", ar: "أفلام جنوب شرق آسيا" },
	"home.tmdb_movie_hk_erotic_comedy": { en: "Wild Hong Kong Comedies", zh: "尽皆癫狂的港产喜剧", "zh-Hant": "盡皆癲狂的港產喜劇", ja: "香港クラシックコメディ", es: "Comedias Clásicas de Hong Kong", ar: "كوميديا هونغ كونغ الكلاسيكية" },
	"home.tmdb_tv_th": { en: "Addictive Thai Dramas", zh: "越狗血越上头的爆款泰剧", "zh-Hant": "越狗血越上頭的爆款泰劇", ja: "人気のタイドラマ", es: "Dramas Tailandeses Populares", ar: "مسلسلات تايلاندية شهيرة" },
	"home.tmdb_movie_th": { en: "Beyond Horror Thai Movies", zh: "别只看鬼片的泰国电影", "zh-Hant": "別只看鬼片的泰國電影", ja: "タイ映画コレクション", es: "Películas Tailandesas", ar: "أفلام تايلاندية" },
	"home.tmdb_tv_bl": { en: "Asian BL Masterpieces", zh: "眼神狂拉丝的亚洲耽美神作", "zh-Hant": "眼神狂拉絲的亞洲耽美神作", ja: "アジアのBLドラマ名作", es: "Dramas BL Asiáticos", ar: "دراما آسيوية مميزة" },
	"home.netflix_minor_tv_shows": { en: "Hidden Gem Foreign Shows", zh: "别被语言劝退的网飞神剧", "zh-Hant": "別被語言勸退的網飛神劇", ja: "Netflix マイナー言語ドラマ", es: "Series de Netflix en Otros Idiomas", ar: "مسلسلات نتفليكس بلغات أخرى" },
	"home.netflix_minor_movies": { en: "Hidden Gem Foreign Movies", zh: "冷门却惊艳的宝藏外国片", "zh-Hant": "冷門卻驚豔的寶藏外國片", ja: "隠れた名作外国映画", es: "Películas Sorprendentes en Otros Idiomas", ar: "أفلام بلغات أخرى" }
};
