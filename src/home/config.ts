 ...
 * Strictly for `/home/config`. Synchronous, pure custom data.
 */
...
const TITLE_TRANSLATIONS: Record<string, Record<Locale, string>> = {
  "home.continue_watching": { en: "继续观看", zh: "继续观看", "zh-Hant": "繼續觀看", ja: "続きを視聴", es: "Continuar Viendo", ar: "متابعة المشاهدة" },
...
function createDefaultBlockTemplates(language: string, timezone: string): HomeBlockTemplate[] {
  return [
    ...
    // 🌟 2. 六大追剧周更表（严格使用 V1 标准的 preset: "collection"）
    {
...
// 🌟 纯同步函数！与原作者原版一模一样！直接返回对象，绝不产生 Promise 空对象！
