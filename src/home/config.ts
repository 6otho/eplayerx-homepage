...
const TITLE_TRANSLATIONS: Record<HomeTitleKey, Record<Locale, string>> = {
  ...
  "home.weekly_drama": { en: "Weekly Chinese Drama", zh: "国产追剧周更表", "zh-Hant": "國產追劇周更表", ja: "中国ドラマ週間更新", es: "Drama Chino Semanal", ar: "دراما صينية أسبوعية" },
  ...
  "home.popular_taiwanese_movies": { en: "Popular Taiwanese Movies", zh: "台味浓浓的宝藏台片", "zh-Hant": "台味濃濃的宝藏台片", ja: "おすすめ台湾映画", es: "Películas Taiwanesas Populares", ar: "أفلام تايوانية شائعة" }
};
...
function createDefaultBlockTemplates(language: string, timezone: string): HomeBlockTemplate[] {
  return [
    ...
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_popular_movies", itemEnvelope: "data" }
    },
    {
      id: "tmdb_popular_tv",
      mediaType: "tv",
    ...
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/variety_cn", itemEnvelope: "data" }
    },
    {
      id: "variety_kr",
      mediaType: "tv",
    ...
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/prime_hot_anime", itemEnvelope: "data" }
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/filmarks_anime_movie", itemEnvelope: "data" }
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/netflix_hot_anime", itemEnvelope: "data" }
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_anime_top_ja", itemEnvelope: "data" }
    },
    {
    ...
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_movie_tw", itemEnvelope: "data" }
    },
    {
      id: "tmdb_movie_sea",
      mediaType: "movie",
