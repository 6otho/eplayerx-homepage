  ...
  return [
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_popular_tv", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_popular_movies", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "bangumi_airing",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/bangumi_airing", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "imdb_top_anime",
      mediaType: "tv",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/imdb_top_anime", itemEnvelope: "data" },
    },
    {
      id: "prime_hot_anime",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/prime_hot_anime", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/filmarks_anime_movie", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/netflix_hot_anime", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_anime_top_ja", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_anime_jp",
      mediaType: "tv",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_anime_jp", itemEnvelope: "data" },
    },
    {
    ...
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_anime_cn", itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_netflix",
      mediaType: "tv",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_tv_netflix", itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_hbo",
      mediaType: "tv",
    ...
    },
    {
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_tv_apple", itemEnvelope: "data" },
    },
    {
      id: "trakt_movies",
      mediaType: "movie",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/trakt_movies", itemEnvelope: "data" },
    },
    {
      id: "trakt_shows",
      mediaType: "tv",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/trakt_shows", itemEnvelope: "data" },
    },
    {
      id: "douban_movies",
      mediaType: "movie",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/douban_movies", itemEnvelope: "data" },
    },
    {
      id: "douban_tv",
      mediaType: "tv",
      ...
      showRank: true,
      showOverview: true,
      source: { path: "https://homepage.eplayerx.cc.cd/api/douban_tv", itemEnvelope: "data" },
    },
    {
      id: "variety_cn",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/variety_cn", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "variety_kr",
      mediaType: "tv",
    ...
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_movie_tw", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_movie_hk_erotic_comedy", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_th",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_tv_th", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_movie_th",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_movie_th", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_movie_sea",
      mediaType: "movie",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_movie_sea", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_es",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_tv_es", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "netflix_tv_minor",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/netflix_tv_minor", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/netflix_movie_minor", query: { sort: "year" }, itemEnvelope: "data" },
    },
    {
      id: "tmdb_tv_bl",
      mediaType: "tv",
      ...
      showOverview: true,
      sort: "year",
      source: { path: "https://homepage.eplayerx.cc.cd/api/tmdb_tv_bl", query: { sort: "year" }, itemEnvelope: "data" },
    },
